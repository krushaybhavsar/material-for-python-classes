...
class App:
    ...
    def __init__(self):
        ...
        # Images
        self.bird = pygame.transform.scale(pygame.image.load(r'C:\Users\krush\OneDrive\Desktop\Side Projects\PythonProjects\FlappyBirdPygame\images\bird.png'), (47, 33)) 
        self.bg = pygame.transform.scale(pygame.image.load(r'C:\Users\krush\OneDrive\Desktop\Side Projects\PythonProjects\FlappyBirdPygame\images\bg.png'), (750, 420)) 
    ...
    def draw_screen(self):
        if self.state == 'start':
            ...
            self.base.draw_start_floor()
        elif self.state == 'playing':
            self.screen.fill((255,255,255))
            self.screen.blit(self.bg, (0,0))
            self.draw_pipes()
            self.base.draw_playing_floor()
